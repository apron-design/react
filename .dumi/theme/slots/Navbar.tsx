...
const Navbar: React.FC<{ location: any }> = ({ location }) => {
  ...
  useEffect(() => {
    ...
    document.documentElement.setAttribute('data-prefers-color', savedTheme);
  }, []);
  ...
  const toggleTheme = () => {
    ...
    document.documentElement.setAttribute('data-prefers-color', newTheme);
